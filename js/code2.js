var questions = [
    ["Question : Magnetic field intensity at the center of arc is:", "F = (&#956<sub>o</sub>*I*l)/4&#982r<sup>2</sup>", "F = (&#956<sub>o</sub>*I*l)/4&#982r<sup>3</sup>", "F = (&#956<sub>o</sub>*I*l)/4&#982r", " F = (2&#956<sub>o</sub>*I*l)/4&#982r<sup>4</sup>"],

["Question : M.F intensity of circular coil carrying n turns is:", "F = (&#956<sub>o</sub>*I*n)/2r<sup>2</sup>", "F = (&#956<sub>o</sub>*I*n)/4r", "F = (2&#956<sub>o</sub>*I*n)/3r", "F = (&#956<sub>o</sub>*I*n)/2r"],


["Question :  The graph is between:", "Distance X and M.F", "M.F and tanθ", "Distance X and tanθ", "M.F and current"],
["Question  :Mirror is provided at the base of the box for: ", "Measuring correct deflection of the magnetic needle by removing parallax between pointer and needle", "Magnifying the deflection", "Clearly and precisely take the reading", "All of the above"],

["Question : Apparatus used to reverse the direction of the current in the circuit is:", "Plug key", "Commutator key", "Tangent galvanometer", "Battery"]
,["Question : Unit of Magnetic field intensity is:", "Tesla", "N-m", "Joule", "Henry"]
,


["Question :For a circular coil Magnetic force is directly proportional to: ", "n l r", "n l", "4πnI", "None Of these"],
["Question : According to tangent law F is directly proportional to:", "Tanθ", "H", "Sin2θ", "2nπI"],
...
var choices=["A",'D',"C","D","B","A","B","A","B","B","C","A"];
var x;
var att=0,p=0,s=0;
getquestion();
